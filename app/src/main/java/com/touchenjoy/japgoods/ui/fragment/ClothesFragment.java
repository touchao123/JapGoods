...
public class ClothesFragment extends BaseFragment{
    ...
    public void onFresh(){
        ...
        bmobQuery.addWhereEqualTo("category","衣服");
...
//                Log.d(TAG, "onSuccess: first one: "+list.get(0).getName());
                ArrayList<BaseEntity> clothesLists= new ArrayList<BaseEntity>();
                ...
                baseRecyclerViewAdapter= new BaseRecyclerViewAdapter(getActivity(),clothesLists);

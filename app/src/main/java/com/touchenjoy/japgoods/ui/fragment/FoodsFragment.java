...
public class FoodsFragment extends BaseFragment {
    ...
    public void onFresh(){
        ...
        bmobQuery.addWhereEqualTo("category","饮食");
...
//                Log.d(TAG, "onSuccess: first one: "+list.get(0).getName());
                ArrayList<BaseEntity> foodLists= new ArrayList<BaseEntity>();
                ...
                baseRecyclerViewAdapter= new BaseRecyclerViewAdapter(getActivity(),foodLists);
